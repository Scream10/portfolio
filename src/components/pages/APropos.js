        ...
        <>
            ...
            <div className="apropos">
                ...
                <div className="container-text">
                    ...
                    <p>Passionné par le web, j'ai suivi deux formations développeur fullstack, The Hacking 
                    Project et Le Wagon pour lesquelles j'ai obtenu une certification Bac +3 en développement web. Rapidement 
                    ...
                    <br/><br/>Je serai ravi de développer de nouveaux projets, n'hésitez pas à me contacter pour me 
            ...
            <section className="working-method">
                <div className="working-method__box">
                    ...
                    <div className="working-method__content">
                        ...
                        attentes. Et de mon côté j'évalue les outils nécessaires à la bonne réalisation du 
                ...
                <div className="working-method__box">
                    ...
                    <div className="working-method__content">
                        ...
                        <br/>2) Je réalise moi-même le design des maquettes UI/UX (interface utilisateur / expérience 
                        utilisateur). 
                        <br/>3) Vous choisissez un template sur WordPress.
                        <br/>Puis nous validons ensemble la maquette pour permettre de passer à l'étape de développement.
                        </p>
